import { Card, Button, Table, Alert, Form, Input, Modal, Tooltip } from 'antd'
import '../styles/view-loadcent.scss'
import type { ColumnsType } from 'antd/es/table'
import { createLoadCent, deleteLoadCent, getLoadCent, updateLoadCent } from '../api'
  ...
  return (
    <>
      ...
      <Card>
        ...
        <Table columns={columns} dataSource={dataLoadCent} rowKey={(record) => record.id} scroll={{ x: 0 }} />
      </Card>
    </>
  )
}
